...
public class ArtistParams extends Params {
    ...
    /**
     * Possible types of descriptions
     */
     ...
     */
    public void addDescription(DescriptionType type, String term) {
     ...
     * @param boost the boost
     */
    public void addDescription(DescriptionType type, String term, float boost) {
     ...
     */
    public void banDescription(DescriptionType type, String term) {
     ...
     * Adds a genre
     *
     * @param genre the genre (one of the genres returned by list_genre
     */
    ...
    public void includeAll() {
        ...
        includeBlogs();
        includeDiscovery();
        includeDiscoveryRank();
        includeDocCounts();
        includeFamiliarity();
        includeFamiliarityRank();
        includeGenres();
        includeHotttnesss();
        includeHotttnesssRank();
        includeImages();
        includeNews();
        includeReviews();
        includeSongs();
    ...
    public void includeDiscovery() {
        add("bucket", "discovery");
    }

    public void includeDiscoveryRank() {
        add("bucket", "discovery_rank");
    }
    ...
    public void includeFamiliarityRank() {
        add("bucket", "familiarity_rank");
    }
    ...
    public void includeHotttnesssRank() {
        add("bucket", "hotttnesss_rank");
    }
