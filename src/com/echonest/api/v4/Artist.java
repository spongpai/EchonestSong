...
public class Artist extends ENItem {
    ...
    public double getHotttnesssRank() throws EchoNestException {
        fetchBucket("hotttnesss_rank");
        return getDouble("hotttnesss_rank");
    }
   ...
   /**
    ...
    /**
     * Gets a map of URLs for this artistpublic Map getData(){
    	return data;
    }
     * 
     * @return
    ...
    public double getFamiliarityRank() throws EchoNestException {
        //fetchBucket("familiarity_rank");
        return getDouble("familiarity_rank");
    }
    
    public double getDiscovery() throws EchoNestException {
        return getDouble("discovery");
    }
    
    public double getDiscoveryRank() throws EchoNestException {
        return getDouble("discovery_rank");
    }
    
    @SuppressWarnings("unchecked")
    public List<String> getGenres() throws EchoNestException {
        String bucket = "genres";
        fetchBucket(bucket);
        return listToGenres((List) getObject(bucket));
    }

    
    @SuppressWarnings("unchecked")
    private List<String> listToGenres(List docs) throws EchoNestException {
