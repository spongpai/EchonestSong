...
public class SearchSongsExample {
	 private EchoNestAPI en;
	    ...
	    public void searchSongsByTitleArtist(String title, String artist, int results)
	            throws EchoNestException {
	    	ArtistParams ap = new ArtistParams();
	        ap.addName(artist);
	        List<Artist> artists = en.searchArtists(ap);
	        if (artists.size() > 0) {
		        ...
		        p.includeSongCurrency();
		        p.includeSongCurrencyRank();
		        p.includeSongDiscovery();
		        p.includeSongDiscoveryRank();
		        p.includeSongHotttnesss();
		        p.includeSongHotttnesssRank();
		        p.includeSongType();
		        
		        p.includeArtistDiscovery();
		        p.includeArtistDiscoveryRank();
		        p.includeArtistFamiliarity();
		        p.includeArtistFamiliarityRank();
		        p.includeArtistHotttnesss();
		        p.includeArtistHotttnesssRank();
		        p.includeArtistLocation();
...
//		        }
	    ...
	    public static void main(String[] args) throws EchoNestException {
	        ...
	        System.out.println();
	        sse.searchSongsByTitleArtist("Back To The Shack", "Weezer", 5);
	        //sse.searchSongsByTitle("Wonderwall",2);
	        
	        System.out.println();
	        System.out.println("Songs by Weezer");
	        //sse.searchSongsByArtist("weezer", 2);
/*
	        System.out.println();
